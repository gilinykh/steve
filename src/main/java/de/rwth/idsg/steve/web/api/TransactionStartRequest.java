...
public class TransactionStartRequest {
    ...
    @JsonCreator
    public TransactionStartRequest(@JsonProperty("chargeBoxId") String chargeBoxId,
    ...
    public RemoteStartTransactionParams asParams(OcppTransport transport, String endpointAddress) {
